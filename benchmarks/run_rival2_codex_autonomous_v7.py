"""Protected 30-microstep learning window from the promoted V4 checkpoint."""
...
campaign.AUTHORITY = campaign.ROOT / "results/rival2/codex_autonomous_v7/authority.json"
campaign.RESULTS = campaign.ROOT / "results/rival2/codex_autonomous_v7"
campaign.CHECKPOINTS = campaign.ROOT / "checkpoints/rival2/codex_autonomous_v7"
campaign.DEFAULT_RUN_DIR = Path("G:/dev/RivalSim-runs/codex-autonomous-v7")
...
campaign.EVALUATION_INTERVAL = 5
campaign.CAMPAIGN_IDENTITY = "RIVAL2_CODEX_AUTONOMOUS_V7"
campaign.AUTHORITY_FORMAT = "RIVAL2_CODEX_AUTONOMOUS_V7_AUTHORITY"
campaign.PREFLIGHT_FORMAT = "RIVAL2_CODEX_AUTONOMOUS_V7_PREFLIGHT"
campaign.RESULT_FORMAT = "RIVAL2_CODEX_AUTONOMOUS_V7_RESULT"
campaign.STATE_FORMAT = "RIVAL2_CODEX_AUTONOMOUS_V7_STATE"
