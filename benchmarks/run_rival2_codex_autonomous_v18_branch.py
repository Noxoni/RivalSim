"""Low-noise analog PPO branches aligned with deterministic deployment."""
...
from benchmarks.run_rival2_codex_autonomous_v17_branch import (
    SOURCE,
    SOURCE_SHA256,
    _window_evaluation,
)
...
BRANCH_SEEDS = (2_026_090_251, 2_026_090_253, 2_026_090_257, 2_026_090_259)
AUTHORITY = ROOT / "results/rival2/codex_autonomous_v18/authority.json"


def _configure(branch_seed: int) -> Path:
    branch = str(branch_seed)
    run_dir = Path(f"G:/dev/RivalSim-runs/codex-autonomous-v18/branches/{branch}")
    campaign.SOURCE = SOURCE
    campaign.SOURCE_SHA256 = SOURCE_SHA256
    campaign.AUTHORITY = AUTHORITY
    campaign.RESULTS = ROOT / f"results/rival2/codex_autonomous_v18/branches/{branch}"
    campaign.CHECKPOINTS = (
        ROOT / f"checkpoints/rival2/codex_autonomous_v18/branches/{branch}"
    )
    ...
    campaign.CAMPAIGN_IDENTITY = "RIVAL2_CODEX_AUTONOMOUS_V18"
    campaign.AUTHORITY_FORMAT = "RIVAL2_CODEX_AUTONOMOUS_V18_AUTHORITY"
    campaign.PREFLIGHT_FORMAT = "RIVAL2_CODEX_AUTONOMOUS_V18_PREFLIGHT"
    campaign.RESULT_FORMAT = "RIVAL2_CODEX_AUTONOMOUS_V18_RESULT"
    campaign.STATE_FORMAT = "RIVAL2_CODEX_AUTONOMOUS_V18_STATE"
