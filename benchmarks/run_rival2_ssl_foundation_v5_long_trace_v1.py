...
def authority_payload(commit: str, created_utc: str):
    ...
    payload["operational_inference_optimization"] = {
        ...
        "unused_frozen_hidden": "advance full recurrent path unless no frozen opponent is active",
        "frozen_gru_batch": "full encoder/GRU batch preserved; compact base trunk and actor heads",
